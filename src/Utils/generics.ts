...
export const generateMessageID = () => 'ARUGAZ' + randomBytes(7).toString('hex').toUpperCase()
...
export const fetchLatestBaileysVersion = async(options: AxiosRequestConfig<any> = { }) => {
	const URL = 'https://raw.githubusercontent.com/arugaz/node-whatsapp/master/src/Defaults/baileys-version.json'
	try {
